...
| `skills/ubersuggest/` | Neil Patel Ubersuggest MCP (42 SEO tools across domain analysis, keyword research, backlinks, site audit, AI brand visibility, content, projects, utilities) — second-source SEO alongside DataForSEO, OAuth 2.0 Bearer auth, JSON-RPC over SSE. | active |
