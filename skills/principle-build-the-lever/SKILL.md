...
tags: [principle, automation, codemod, script]
status: active
created: 2026-08-28
---
...
Original source: https://github.com/cursor/plugins/blob/main/pstack/skills/principle-build-the-lever/SKILL.md

Retrieved 2026-08-28 from upstream pstack for THNKBIG Tier 1 rollout. Inner frontmatter and body are verbatim from upstream. Cross-references to sibling principles use repo-local paths (`../principle-*/SKILL.md`) and resolve after `scripts/sync-skills.sh` runs on each machine.
